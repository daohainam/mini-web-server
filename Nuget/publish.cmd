...
nuget push ..\Middleware\Mvc\bin\%PublishProfile%\MiniWebServer.Mvc.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
nuget push ..\Middleware\OutputCaching\bin\%PublishProfile%\MiniWebServer.OutputCaching.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
nuget push ..\Middleware\Session\bin\%PublishProfile%\MiniWebServer.Session.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
...
nuget push ..\MiniWebServer.Abstractions\bin\%PublishProfile%\MiniWebServer.Abstractions.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
...
nuget push ..\MiniWebServer.MiniApp\bin\%PublishProfile%\MiniWebServer.MiniApp.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
nuget push ..\MiniWebServer.Mvc.Abstraction\bin\%PublishProfile%\MiniWebServer.Mvc.Abstraction.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
...
nuget push ..\MiniWebServer.Server\bin\%PublishProfile%\MiniWebServer.Server.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate
nuget push ..\MiniWebServer.Server.Abstractions\bin\%PublishProfile%\MiniWebServer.Server.Abstractions.0.3.2.nupkg -Source %NugetSource% -SkipDuplicate