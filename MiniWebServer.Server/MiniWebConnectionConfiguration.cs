...
namespace MiniWebServer.Server
{
    public class MiniWebConnectionConfiguration
    {
        ...
        public MiniWebConnectionConfiguration(int id, TcpClient tcpClient, Stream clientStream, IProtocolHandler protocolHandler, IDictionary<string, Host.Host> hostContainers, TimeSpan executeTimeout, int readRequestBufferSize)
        {
            Id = id;
            TcpClient = tcpClient;
